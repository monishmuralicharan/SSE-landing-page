        ...
        <section id="faq" className="py-10 lg:py-20">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <a href="mailto:thesocialstockexchange@gmail.com" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">thesocialstockexchange@gmail.com</a>
                </div>
